    ...
    */
    ...
    void Update()
    {
       // player = GameObject.Find("Player");
        ...
        /*
        if (Input.GetKeyDown(KeyCode.Z) || Input.GetButton("XboxX"))
        {
            Renderer.material.SetTexture("_MainTex", Texure1);
        }
        if (Input.GetKeyDown(KeyCode.X) || Input.GetButton("XboxY"))
        {
            Renderer.material.SetTexture("_MainTex", Texure2);
        }
        if (Input.GetKeyDown(KeyCode.C) || Input.GetButton("XboxA"))
        {
            Renderer.material.SetTexture("_MainTex", Texure3);
        }
        if (Input.GetKeyDown(KeyCode.V) || Input.GetButton("XboxB"))
        {
        ...
        if (gazedCheck == 1)
        {
            ...
            if (Input.GetKeyDown(KeyCode.R) || Input.GetButtonDown("LB"))
            {
